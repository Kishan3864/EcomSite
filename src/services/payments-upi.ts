...
<p><a href="${url}" style="background:#0a0c0f;color:#fff;padding:10px 18px;text-decoration:none;border-radius:6px">Open the order</a></p>
<p style="color:#676d77">Nothing is dispatched until you confirm.</p>`,
  }).catch(() => {});
