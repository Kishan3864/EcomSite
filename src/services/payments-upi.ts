...
<p><a href="${url}" style="background:#0f1115;color:#fff;padding:10px 18px;text-decoration:none;border-radius:6px">Open the order</a></p>
<p style="color:#666">Nothing is dispatched until you confirm.</p>`,
  }).catch(() => {});
