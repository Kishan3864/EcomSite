...
export function WishlistClient() {
  ...
  if (!hydrated) {
    return (
      <div className="tile-grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
        {[0, 1, 2, 3, 4].map((i) => (
  ...
  return (
    <>
      ...
      <ul className="tile-grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
