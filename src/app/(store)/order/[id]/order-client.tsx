    ...
    <div className="container-page py-6 sm:py-12">
      ...
      <div className="mx-auto max-w-3xl">
        <header className="text-center">
          ...
          <div className="mt-5 inline-flex max-w-full flex-wrap items-center justify-center gap-x-3 gap-y-1 card px-3 py-2.5 sm:mt-6 sm:px-4">
        ...
        <Reveal delay={0.08} className="mt-7 space-y-3 sm:mt-10 sm:space-y-4">
          ...
          {/* Delivery promise */}
          <div className="flex flex-wrap items-center justify-between gap-3 card p-4 sm:gap-4 sm:p-5">
            <div className="min-w-0">
