 ...
 * in gold. Purely decorative, so it is hidden from screen readers; the
...
export function AuthArt({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      {/* The parcel. Front, top and side faces — square, banded in gold.
      ...
      <g>
        ...
        {/* The band, carried across all three faces so the box reads as solid.
            One gold at three strengths — brightest where the top catches the
