 ...
 * in saffron. Purely decorative, so it is hidden from screen readers; the
  ...
  return (
    ...
    >
      ...
      {/* Two soft washes, so the flat ground has depth without a photograph.
          ...
          way out. */}
      <defs>
        <radialGradient id="auth-wash-saffron" cx="0.5" cy="0.5" r="0.5">
          <stop
            offset="0"
        ...
        <radialGradient id="auth-wash-indigo" cx="0.5" cy="0.5" r="0.5">
          <stop
            offset="0"
      ...
      <circle cx="380" cy="110" r="150" fill="url(#auth-wash-saffron)" />
      <circle cx="130" cy="360" r="170" fill="url(#auth-wash-indigo)" />
      ...
      {/* The parcel. Front, top and side faces — square, banded in saffron.
          Three steps of the one indigo do all the shading, and the face that
      ...
      <g>
        ...
        {/* The band, carried across all three faces so the box reads as solid.
            One saffron at three strengths — brightest where the top catches the
